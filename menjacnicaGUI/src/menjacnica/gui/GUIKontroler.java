...
public class GUIKontroler {
	...
	public static void ugasiAplikaciju() {
		...
		int vrednost = JOptionPane.showConfirmDialog(menjacnicaGUI.getContentPane(),
				"Da li zelite da izadjete iz programa?", "Zatvaranje aplikacije", JOptionPane.YES_NO_CANCEL_OPTION);
